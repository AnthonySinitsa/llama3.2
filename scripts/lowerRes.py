...
def process_image():
    ...
    input_image_path = "images/KaysHours3.jpg"
    resized_image_path = "images/resized/KaysHours3_resized.jpg"
    ...
    messages = [
        {"role": "user", "content": [
            {"type": "image"},
            {"type": "text", "text": "Given this image, output the information you see into a json format."}
        ]}
    ]
    ...
    print("Output saved to output_text.txt")
